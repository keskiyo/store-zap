	...
	(
		...
		return (
			<SliderPrimitive.Root
				...
				{...props}
			>
				<SliderPrimitive.Track className='relative h-1 w-full grow overflow-hidden rounded-full bg-primary/2 bg-gray-200'>
					<SliderPrimitive.Range className='absolute h-full bg-primary bg-orange-500' />
